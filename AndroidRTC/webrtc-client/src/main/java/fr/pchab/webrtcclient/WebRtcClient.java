...
public class WebRtcClient {
    ...
    private class ProcessUserMessageCommand implements Command {
        public void execute(String peerId, JSONObject payload) throws JSONException {
            Log.d(TAG, "ProcessUserMessageCommand");
            mListener.onMessageReceived(payload.getString("msg"));
        }
    }
    ...
    private class MessageHandler {
        ...
        private MessageHandler() {
            ...
            commandMap.put("message", new ProcessUserMessageCommand());
        }
